...
@click.command(
    "unidock-moo",
    help="Vina-QED multi-objective optimization with GPU-accelerated UniDock (multiplicative reward).",
)
...
def unidock_moo(
    ...
    if wandb_name is not None:
        wandb.init(project="rxnflow", name=wandb_name, group="unidock-mogfn")
